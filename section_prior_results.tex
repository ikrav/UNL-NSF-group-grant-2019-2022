...
% Pixels, 2007-2014 - removed, briefly mentioned at the bottom
...
% DASPOS - removed, mentioned at the end
...
% ARA - removed, briefly mentioned at the bottom.
...
Bloom has overseen the operation of UNL's Tier-2 computing center, along with David Swanson of UNL's Holland Computing Center (HCC). This center is one of seven in the US and fifty in all of CMS. The center is supported by two full-time staff members, and currently operates about 9500 batch slots and hosts 4.7~PB of data. The Nebraska center is routinely ranked among the best in all of CMS in just about every metric, and has typically been the pathfinder site for modernization of operations. Bloom also continues to serve as a CMS-wide co-coordinator for all Tier-2 centers.
...
{\bf Phase~1 pixel detector upgrade}
...
%The group has now largely closed out its involvement with the DZERO experiment 
...
%moved some of this from the Broader Impacts section
...
%XXX Greg's part: commented out (but was still todo anyways)
%{\bf Update Auger outreach if Greg's activities fall within the past five years!}

%XXX Greg's part: Greg would need to review this for completeness if he were in. 
...
%XXX Greg's name removed below
%
%Along with Claes, Snow is a member of UNL's Speakers Bureau~\cite{bib:speakers}, and has given presentations on the Higgs boson and ultra-high energy cosmic rays to civic groups, clubs and schools.
%
