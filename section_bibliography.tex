...
\bibitem{bib:AAA} K.~Bloom, T.~Boccali, B.~Bockelman, D.~Bradley, S.~Dasu,
  ...
  %
\bibitem{bib:hepcloud} {\bf Get a HEPCloud reference paper, something else
    demonstrating elasticity etc.}
  \bibitem{bib:MONIT} {\bf Find a MONT reference if possible.}
%
...
\bibitem{bib:tH_theory} F.~Demartin, F.~Maltoni, K.~Mawatari, and M.~Zaro,
  ...
  associated production at the LHC'', European Physical Journal {\bf C77}, 34 (2017). arXiv:1607.05862
