...
%
%Bloom and postdocs and students collaborating with him will work in this area at the start of Run~3.
...
%
%In Run~3, LHC will operate at an increased 14~TeV collision energy, cross sections of SM processes will be different and
%
...
%inclusive $Z$ production cross section and the 
...
\paragraph{Exotic phenomena beyond the standard model}
 ...
 %is now constrained to be around the TeV scale.  
 ...
 %In the context of this work, they will investigate modes of resonant production. 
 ...
 %The plan is to develop the analysis through 2018.
...
%After the introduction of CUA as a new production site, some UNL equipment was transferred there, and will be re-acquired as described below. Among the critical items, the F\&K Delvotec G5 64000 wirebonder remains at UNL.
...
%
%The experiment's Physics Object Groups (POG) develop reconstruction for these objects, 
